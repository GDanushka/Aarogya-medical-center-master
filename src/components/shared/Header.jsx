...
export default function Header() {
    ...
    return (
        <div className='bg-white h-16 px-4 flex justify-between items-center border-b border-gray'>
            <div className='relative'>
                <HiOutlineSearch fontSize={20} className="text-gray-400 absolute top-1/2 left-3 -translate-y-1/2" />
                <input type="text" placeholder='Search' className='text-sm focus:outline-none active:outline-none h-10 w-[24rem] border border-gray p-2 pl-10 rounded-sm' />
            </div>
                ...
                <Popover className="relative">
                    {({ open }) => (
                        <>
                            ...
                            >
                                <HiOutlineChatAlt fontSize={20} className="text-gray-600" />
                            </Popover.Button>
                            <Transition
                                as={Fragment}
